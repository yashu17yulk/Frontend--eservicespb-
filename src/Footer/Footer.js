...
render()
{
  return(
      ...
      {/* <div class="container-fluid1">
        <div class="row">
          <div class="col11">
          © Copyright National Informatics Centre  
          </div>
          <div class="col11">
          Contents as provided, updated and permitted by the Government of Punjab, 
          </div>
          <div class="col11">
          Site is technically designed, hosted and maintained by National Informatics Centre and Powered by - <b>ServicePlus.</b>  
          </div>
        </div>
        </div> */}
